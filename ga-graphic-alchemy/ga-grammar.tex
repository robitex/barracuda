...
OpCode & Mnemonic key & Graphic object/Operands\\
\midrule
 130 & text         & A text with several gliphs\\
     & & \ttfamily <ax: FLOAT> <ay: FLOAT> <x: DIM> <y: DIM> <s: STRING>\\
\midrule
 131 & text\_spaced & A text line with gliphs equally spaced \\
     & & \ttfamily <ax: FLOAT> <ay: FLOAT> <x: DIM> <y: DIM> <gap: DIM> <s: STRING>\\
\midrule
 132 & start\_text\_group & Texts on the same baseline \\
\midrule
 133 & gtext         & A sequence of gliphs sharing a baseline\\
     & & \ttfamily <s: STRING> \\
\midrule
 134 & gtext\_spaced & Gliphs separated by a fixed distance sharing a baseline\\
     & & \ttfamily <gap: DIM> <s: STRING> \\
\midrule
 135 & gtext\_space  & A distance between to consecutive text sharing a baseline\\
     & & \ttfamily <gap: DIM>\\
\midrule
 140 & end\_text\_group & End text group\\
